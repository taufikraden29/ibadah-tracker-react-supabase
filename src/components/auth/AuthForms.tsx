...
export function AuthForms() {
  ...
  const handleOAuthSignIn = async (provider: 'google' | 'github') => {
    ...
    try {
      ...
      // OAuth will redirect, so no navigation needed here
    } catch (error) {
      setAuthError(`An unexpected error occurred with ${provider} sign in`)
      setIsLoading(false)
    }
  }
      ...
      <div className="w-full max-w-md">
        <Card className="shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Track your daily prayers and Quran reading
            </CardDescription>
          </CardHeader>
